...
describe('DeleteCommentUseCase', () => {
  it('should orchestrating delete comment action correctly', async () => {
    ...
    mockCommentRepository.verifyCommentExistenceInThread = jest.fn()
    ...
    // Assert
    expect(mockCommentRepository.verifyCommentExistenceInThread).toBeCalledWith(useCasePayload.commentId, useCasePayload.threadId);
